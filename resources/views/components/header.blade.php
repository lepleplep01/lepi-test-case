<header x-data="{ mobileOpen: false, searchOpen: false }" class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 font-sans">
    ...
    <div class="w-full bg-white">
        ...
        <div class="max-w-full mx-auto px-12 h-[76px] flex items-center justify-between">
            <!-- Logo & Hamburger (kiri) -->
            ...
            <div class="hidden xl:flex items-center gap-6">
                <nav class="flex items-center space-x-6 text-sm font-medium text-gray-800">
                            ...
                            <div class="max-w-full mx-auto px-12">
                                <div class="grid grid-cols-3 border-l border-t border-gray-200">
                                    ...
                                    <div class="p-6 border-b border-gray-200 hover:bg-white/50 transition">
                                        ...
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">Effective website with
                                    ...
                                    <div class="p-6 border-r border-b border-gray-200 hover:bg-white/50 transition">
                                        <h3 class="font-medium text-gray-900 text-xl mb-2">Search Engine Optimization
                                        </h3>
                                    ...
                                    <div class="p-6 border-b border-gray-200 hover:bg-white/50 transition">
                                        <h3 class="font-medium text-gray-900 text-xl mb-2">Community Program Development
                                        </h3>
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">We help the business to
                                            retain customers, and encourages them to explore more of your products and
                                            services.</p>
                    ...
                    <!-- PROGRAM DROPDOWN -->
                    <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <button class="flex items-center gap-1 hover:text-blue-600 transition-colors whitespace-nowrap">
                            Program
                            <svg :class="open ? 'rotate-180' : ''" class="w-4 h-4 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="max-w-full mx-auto px-12">
                                <div class="grid grid-cols-3 border-l border-t border-gray-200">
                                    ...
                                    <div class="p-6 border-r border-b border-gray-200 hover:bg-white/50 transition">
                                        ...
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">"Good Food Ends with
                                            Good Talk" – Monthly sharing session over breakfast with industry leaders.
                                        </p>
                                        <a href="#"
                                    ...
                                    <div class="p-6 border-r border-b border-gray-200 hover:bg-white/50 transition">
                                        <h3 class="font-medium text-gray-900 text-xl mb-2">Partnership & Collaboration
                                        </h3>
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">Generating and expanding
                                    ...
                                    <div class="p-6 border-b border-gray-200 hover:bg-white/50 transition">
                                        ...
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">Trends and insights for
                            ...
                            <div class="max-w-full mx-auto px-12">
                                <div class="grid grid-cols-2 border-l border-t border-gray-200 max-w-3xl">
                                    ...
                                    <div class="p-6 border-r border-b border-gray-200 hover:bg-white/50 transition">
                                        ...
                                        <p class="text-gray-600 text-base leading-relaxed mb-3">We're not just a player
                                            in this industry; we're visionaries. Discover our journey into the world of
    ...
    <div x-show="mobileOpen" x-transition:enter="transition ease-out duration-300"
        ...
        class="xl:hidden bg-white border-t border-gray-200 py-6 px-12 w-full h-screen overflow-y-auto" x-cloak>
        <nav class="space-y-6">
            <div x-data="{ open: false }">
                <button @click="open = !open"
                    class="flex items-center justify-between w-full text-lg font-bold text-gray-900 leading-none">
                    Services
            ...
            <a href="#" class="block text-lg font-bold text-gray-900 leading-none">Loyalty Program</a>
            <a href="#" class="block text-lg font-bold text-gray-900 leading-none">Web & SEO Audit</a>

            <div class="pt-6">
                <a href="https://api.whatsapp.com/send?phone=6281805757585" target="_blank"
                    class="flex items-center justify-center gap-2 bg-[#5B84C4] text-white text-base font-bold px-6 py-4 rounded-xl w-full shadow-lg">
                    <img src="https://bolehdicoba.com/wp-content/uploads/2024/10/32px-WhatsApp_icon.png"
